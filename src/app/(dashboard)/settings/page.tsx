...
import { Plus, RefreshCw, Trash2, CheckCircle2, XCircle, Loader2 } from "lucide-react";
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Paste your Meta Ad Account ID and a long-lived System User
                    access token. The token will be encrypted before storage.
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleAddAccount} className="flex flex-col gap-4 py-2">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Numeric ID only — omit the &quot;act_&quot; prefix.
                    </p>
                  </div>
                  <div className="flex flex-col gap-1.5">
